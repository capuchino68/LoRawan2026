...
#define NETWORK_ID 0xA5 //ID red
#define MY_ID      6    //ID de dispositivo destinatario
#define PEER_ID    1    //ID de dispositivo remitente
...
void loop() {
  ...
  if (packetSize) {
    ...
    int16_t temp10 = ((int16_t)buffer[5] << 8) | buffer[6];
    float tempC = temp10 / 10.0;
